    ...
    function afficherResultats(resultats, valeur) {
        ...
        resultats.slice(0, 8).forEach(item => {
            ...
            row.innerHTML =
                ...
                '<span class="result-desc">' + extraitPertinent(item, valeur) + '</span>' +
                '<button type="button" class="summary-toggle">Résumé</button>';
            ...
            row.querySelector('.summary-toggle').addEventListener('click', function (e) {
                e.stopPropagation();
                ouvrirResume(item);
            });
